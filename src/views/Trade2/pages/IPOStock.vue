...
<template>
  <div v-if="token" class="page_ipo_stock">
    <Tabs
      animated
      :class="from == 'order' ? 'van-tabs--sub-order' : 'van-tabs--sub'"
    ...
    <div class="list" :class="from == 'order' ? '!px-[0]' : ''">
      ...
      >
        <div class="item_box">
          ...
          <!-- 已中签 -->
          <div
            class="status_ing2 status_success"
          ...
          <!-- 未中签 -->
          <div
            class="status_ing2 status_failure"
          ...
          <!-- 待中签 -->
          <div
            class="status_ing2 status_issuing"
            v-else="item.status == 'issuing'"
          >
