...
<template>
    <div class="stock_block">
        <Tabs  type="oval-card" v-model:active="active" :swipeable="false"
        ...
        >
            ...
            <div class="stock_tab-body">
                <Opening :type="'commodities'" v-if="loadTab.indexOf('0') > -1" @showNavDialog="showNavDialog" @success="openSuccess"
                ref="OpeningRef" />
            </div>
            </SwiperSlide>
            <SwiperSlide>
            <div class="stock_tab-body">
                <Positions :type="'commodities'" v-if="loadTab.indexOf('1') > -1" />
            </div>
            </SwiperSlide>
            <SwiperSlide>
            <div class="stock_tab-body">
                <Inquire :type="'commodities'" v-if="loadTab.indexOf('2') > -1" ref="InquireRef" />
            </div>
            </SwiperSlide>
        </Swiper>
    </div>
