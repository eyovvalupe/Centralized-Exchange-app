...
<template>
  <div class="trade_ai" :class="['trade_ai--' + mode]">
    ...
    <div class="tabs-container">
      <!-- 涨跌 -->
      <Tabs type="line-card-ai" v-model:active="tab" :swipeable="false" animated :color="'var(--ex-primary-color)'">
      ...
      <div v-if="!token" style="margin-top: 0.4rem; padding: 0 0.32rem 0.32rem 0.32rem">
        <Button :color="'var(--ex-bg-white2)'" @click="store.commit('setIsLoginOpen', true)" size="large" round>
    ...
    <Popup teleport="body" v-model:show="showModel" position="bottom" round closeable>
      ...
      <div class="stock_submit_box">
        ...
        <FormItem v-model="form1.safeword" size="large" v-if="userInfo.role != 'guest'" input-type="password"
