<template>
    <div class="pledge_page">
        <Tabs v-model:active="active" id="pledge-tabs" animated type="custom-card-stake" @change="onChange" style="height: calc(var(--vh) * 100 - 0.88rem); overflow-y: auto;" @scroll="onScroll">
