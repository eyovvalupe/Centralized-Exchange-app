    ...
    myChart.setOption({
      ...
      tooltip: {
        ...
        formatter: function (params) {
          return (
            params[2].name +
            '<br /> 收益率：<span style="color:#00D77C">' +
            ((params[2].value - base) * 100).toFixed(1) +
            '%</span><br /> 收益额：<span style="color:#00D77C">' +
            ((params[2].value - base) * Math.random()).toFixed(2) +
            '</span>'
          );
        },
      },
        ...
        },
        {
          ...
          areaStyle: {
            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
              {
                offset: 0,
                color: 'rgba(0, 215, 124, 0.3)',
              },
              {
                offset: 1,
                color: 'rgba(0, 215, 124, 0)',
              },
            ]),
          },
          stack: 'confidence-band',
