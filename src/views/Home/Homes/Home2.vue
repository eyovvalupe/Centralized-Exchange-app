...
<template>
  <div class="page-home2">
    ...
    <div class="home2-content">
      ...
      <!-- 导航 -->
      <div class="dirs">
        <div class="dir-b wow fadeInUp" @click="jump('tradeInfo', false, { tradeType: 'ai' })" :style="{
        ...
        <div class="dir-b wow fadeInUp" @click="jump('finance', false)" :style="{
          backgroundImage: `url(${getStaticImgUrl(
        ...
        <div class="dir-s wow fadeInUp" @click="jump('tradeInfo', false, { tradeType: 'spot' })" :style="{
          backgroundImage: `url(${getStaticImgUrl(
        ...
        <div class="dir-s wow fadeInUp" @click="jump('tradeInfo', false, { tradeType: 'constract' })" :style="{
          backgroundImage: `url(${getStaticImgUrl(
            '/static/home2/dir-s-bg.png',
          )})`,
        }">
        ...
        <div class="dir-s wow fadeInUp" @click="jump('finance', false, { activeTab: 1 })" :style="{
          backgroundImage: `url(${getStaticImgUrl(
            '/static/home2/dir-s-bg.png',
          )})`,
        }">
        ...
        <div class="dir-s wow fadeInUp" @click="jump('finance', false, { activeTab: 2 })" :style="{
          backgroundImage: `url(${getStaticImgUrl(
            '/static/home2/dir-s-bg.png',
          )})`,
        }">
