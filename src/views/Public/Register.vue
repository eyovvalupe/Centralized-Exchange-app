  ...
  <div class="page page-register" v-if="openPage">
    ...
    <template v-else-if="step == 2">
      ...
      <div class="form">
        ...
        <div class="form_item margin_item ripple-btn" v-show="activeTab == 1" :class="{ err_ipt: errorTip.error1 }">
        ...
        <div class="form_item margin_item relative ripple-btn" :class="{ err_ipt: errorTip.error2 }">
        ...
        <div class="form_item margin_item relative ripple-btn" :class="{ err_ipt: errorTip.error3 }">
        ...
        <div class="form_item margin_item ripple-btn">
