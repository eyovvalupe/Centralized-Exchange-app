  ...
  <div class="page page_user">
    ...
    <div class="navs">
      <div class="nav" @click="jump('language')">
        ...
        <div class="lang">
          <div class="mr-[0.1rem]" :class="i18Data.locale == 'zh' ? 'china_icon' : 'us_icon'"></div>
