...
<template>
  <div class="kyc_2">
    ...
    <div class="flex justify-between flex-wrap gap-[0.2rem] mb-[0.4rem]">
      <div class="item">
        <!-- 没有上传 -->
        <div class="id_back1 flex flex-col items-center justify-center" v-if="!files.front.loading && !files.front.url">
      ...
      <div class="item">
        <!-- 没有上传 -->
        <div class="id_back2 flex flex-col items-center justify-center" v-if="!files.back.loading && !files.back.url">
          <div class="camera_icon mb-[0.16rem]"></div>
      ...
      <div class="item">
        <!-- 没有上传 -->
        <div class="id_back3 flex flex-col items-center justify-center" v-if="!files.hand.loading && !files.hand.url">
          <div class="camera_icon mb-[0.16rem]"></div>
...
.delete_svg_icon {
  background-image: url("data:image/svg+xml,%3Csvg%20width%3D%2216%22%20height%3D%2215%22%20viewBox%3D%220%200%2016%2015%22%20fill%3D%22none%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%3Cpath%20d%3D%22M12.2177%203.44727H3.78535C3.68437%203.44727%203.5918%203.52932%203.5918%203.63598V12.317C3.5918%2012.8832%204.06307%2013.3427%204.64374%2013.3427H11.3677C11.6454%2013.3427%2011.9063%2013.236%2012.0999%2013.0473C12.2934%2012.8585%2012.4028%2012.596%2012.4028%2012.3252V3.62778C12.4113%203.52932%2012.3271%203.44727%2012.2177%203.44727ZM6.31001%2010.5611C6.31001%2010.6596%206.26793%2010.758%206.20061%2010.8237C6.12487%2010.8975%206.0323%2010.9303%205.93131%2010.9303C5.72092%2010.9303%205.55261%2010.7662%205.55261%2010.5611V5.99906C5.55261%205.79393%205.72092%205.62983%205.93131%205.62983C6.1417%205.62983%206.31001%205.79393%206.31001%205.99906V10.5611ZM8.38023%2010.5611C8.38023%2010.7662%208.21192%2010.9303%208.00153%2010.9303C7.79114%2010.9303%207.62283%2010.7662%207.62283%2010.5611V5.99906C7.62283%205.79393%207.79114%205.62983%208.00153%205.62983C8.21192%205.62983%208.38023%205.79393%208.38023%205.99906V10.5611ZM10.4589%2010.5611C10.4589%2010.7662%2010.2905%2010.9303%2010.0802%2010.9303C9.86977%2010.9303%209.70146%2010.7662%209.69305%2010.5529V5.99906C9.69305%205.79393%209.86136%205.62983%2010.0802%205.62983C10.2905%205.62983%2010.4589%205.79393%2010.4589%205.99906V10.5611Z%22%20fill%3D%22white%22/%3E%3Cpath%20d%3D%22M13.8404%203.06837H11.0717V2.33811C11.0717%201.8376%2010.6509%201.43555%2010.146%201.43555H5.87932C5.36597%201.43555%204.95361%201.8458%204.95361%202.33811V3.06837H2.15966C1.92403%203.06837%201.73047%203.25709%201.73047%203.48683C1.73047%203.71657%201.92403%203.90529%202.15966%203.90529H13.8404C14.076%203.90529%2014.2696%203.71657%2014.2696%203.48683C14.2696%203.25709%2014.076%203.06837%2013.8404%203.06837ZM10.2133%203.06837H5.81199V2.26426H10.2133V3.06837Z%22%20fill%3D%22white%22/%3E%3C/svg%3E");
  width: 0.32rem;
  height: 0.3rem;
  background-size: contain;
  background-repeat: no-repeat;
