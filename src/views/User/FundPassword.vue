    ...
    <div class="form">
      ...
      <div class="form_item margin_item">
        <input
          ...
          :placeholder="t('change_trade_pw.origin_pw_placeholder')"
      ...
      <div
        class="form_item margin_item mb-[0.05rem]"
        :class="[isSame ? 'border-[#D0D8E2]' : 'border-[#E8503A]']"
      >
        <input
          maxlength="20"
          v-model.trim="form.password"
          :placeholder="t('change_trade_pw.new_pw_placeholder')"
      ...
      >
        <input
          ...
          :placeholder="t('change_trade_pw.confirm_pw_placeholder')"
