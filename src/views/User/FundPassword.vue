    ...
    <div class="form">
      ...
      >
        <input
          ...
          class="item_input"
          :placeholder="$t('change_trade_pw.origin_pw')"
      ...
      <div
        class="form_item margin_item mb-[0.05rem] transition"
      ...
      >
        <input
          ...
          class="item_input"
          :placeholder="$t('change_trade_pw.new_pw')"
      ...
      >
        <input
          ...
          class="item_input"
          :placeholder="$t('change_trade_pw.confirm_pw')"
