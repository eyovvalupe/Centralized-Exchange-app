              ...
              <div class="flex flex-col items-center">
                <div style="float: left">
                  ...
                  <div class="item" @click="showCrypto = true">
                    <div class="item_icon">
                      <div :class="`${form.currency}_big_icon`" v-if="form.currency != 'INR' || form.currency != 'USD'"></div>
    ...
    >
      <div class="">
        ...
        <div class="w-full px-[0.32rem]">
          <div
            class="w-full h-[0.8rem] mt-[0.7rem] rounded-[1rem] bg-[#f4f5f7] flex items-center px-[0.2rem]"
          >
            <SearchIcon />
            <input
              v-model="searchRef"
              type="text"
              class="flex-1 h-[0.6rem] px-[0.2rem] color-[#061023] text-[0.3rem]"
              @input="searchItem"
            />
          </div>
        </div>
        ...
        <div class="bottoms">
          <div
            ...
            v-for="item in searchRef ? searchResult : currencyMapList"
            :key="item"
          >
            <div class="flex w-full justify-between">
              <div class="flex items-center">
                <div :class="`${item}_icon`" class="mr-[0.2rem]" v-if="item != 'INR' && item != 'USD'"></div>
