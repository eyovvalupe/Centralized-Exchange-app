<template>
  <div class="order-update">
    ...
    <div class="order-update-box" v-show="!loading">
      ...
      <Field v-model="addValue" class="lose-field" type="number" @focus="handleFocus(2)" @blur="handleBlur(2)"
        :class="[{ 'focusinput': isFocused === 2 }]" @input="handleInput()" />
      ...
      <div class="ipo-code">
        ...
        <Button size="large" color="var(--ex-primary-color)" round style="margin-bottom: 0.32rem;margin-top: 0.6rem;"
          :disabled="loseValue === '' || value === '' || amount === 0" @click="update"><span
