<template>
  <div class="w-full h-full">
    <div class="page-trade3" ref="tradePageRef">
      <div
        class="z-[1] pt-[0.4rem] pb-[0.4rem] bg-color"
      ...
      >
        ...
        >
          ...
          <div
            class="text-[0.32rem] text-color2 leading-[0.5rem] flex-1 px-[0.1rem]"
          >
            <input
              style="flex: 1; width: 100%"
              v-model.trim="searchRef"
              class="text-white"
              :placeholder="$t('market.market_input_crypto_set')"
              @input="inputHandle"
              @focus="focusRef = true"
              @blur="focusRef = false"
            />
      ...
      <div v-if="focusRef || searchRef">
        <div
          class="pl-[0.38rem] pr-[0.32rem] text-[0.28rem] leading-[0.4rem] pb-[0.08rem]"
          style="
  ...
  <Popup
    ...
    transition-appear
    position="right"
    :style="{ width: '6.8rem', height: 'calc(100vh - 88px)' }"
  >
