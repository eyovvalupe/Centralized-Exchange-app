...
<template>
  ...
  >
      ...
      >
        <div class="flex items-center justify-center gap-[0.2rem]">
          <div class="w-[2.6rem] flex-shrink-0">
            ...
            >
              <span
                class="text-[0.4rem] font-[600]"
                v-if="item.price || item.close"
              >
              ...
              <span class="w-[0.24rem] h-[0.26rem] ml-[0.06rem] mt-[0.06rem]">
                <img
                  v-lazy="getStaticImgUrl('/static/img/market/up_icon.svg')"
                  v-if="updown > 0"
                />
                <img
                  v-lazy="getStaticImgUrl('/static/img/market/down_icon.svg')"
                  v-else-if="updown < 0"
                />
              </span>
            </h1>
            <div
              class="flex mt-[0.2rem]"
              :class="[updown === 0 ? '' : updown > 0 ? 'up' : 'down']"
            >
        ...
        <div class="chart_box">
          <div class="tabs">
            ...
            <div class="full-tab" @click="fullScreen(true)">
              <img
                v-lazy="getStaticImgUrl('/static/img/common/full.svg')"
                alt=""
              />
            </div>
          </div>
    ...
    <div class="market_bottom" v-if="!props.innerPage">
      <div
        class="bottom_btn ripple-btn"
        @click="goBuy(true)"
        style="background-color: var(--ex-up-color)"
      >
      ...
      <div
        class="bottom_btn ripple-btn"
        @click="goBuy(false)"
        style="background-color: var(--ex-down-color)"
      >
        <span class="bottom_btn_icon">
