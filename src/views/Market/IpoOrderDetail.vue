<template>
  <div class="ipo_stock_detail">
    <Top :title="`${t('trade.ipo_detail_title')}`"></Top>
    ...
    <div class="scroller" v-else>
      <div class="status_box" v-if="currDetail.status == 'success'">
        <div style="width: 1.2rem; height: 1.2rem">
          <img
            v-lazy="getStaticImgUrl(`static/img/trade/ipo_detail_success.svg`)"
            alt=""
          />
        </div>
      ...
      <div class="status_box" v-else-if="currDetail.status == 'failure'">
        <div class="status_fail">
          <div style="width: 1.2rem; height: 1.2rem">
            <img
              v-lazy="
                getStaticImgUrl(`static/img/trade/ipo_detail_failure.svg`)
              "
              alt=""
            />
          </div>
      ...
      <div class="status_box" v-else>
        <div style="width: 1.2rem; height: 1.2rem">
          <img
            v-lazy="getStaticImgUrl(`static/img/trade/ipo_detail_wait.svg`)"
            alt=""
          />
        </div>
      ...
      <div class="main_item">
        <div class="item_box">
          ...
          <div class="item_order_no">
            <span
              >{{ t('trade.ipo_detail_order_no') }}
              {{ currDetail.order_no || '--' }}</span
            >
            <div class="item_copy_icon" @click="copy(currDetail.order_no)">
              <img
                v-lazy="getStaticImgUrl('/static/img/common/copy.svg')"
                alt="copy"
              />
            </div>
          </div>
          ...
          <div class="info_boxs">
            <div
              class="info_box"
              style="border-bottom: 0.02rem dashed var(--ex-bg-white2)"
            >
              <div
              ...
              >
                ...
                <div class="text-center">
                  {{ t('trade.ipo_detail_win_num') }}
                </div>
              </div>
            </div>
            <div
              class="info_box info_box--line"
              style="border-bottom: 0.02rem dashed var(--ex-bg-white2)"
            >
              <div class="amount">
                {{ currDetail.volume || '--' }}
            ...
            <div class="info_box">
              <div class="w-full flex flex-col" style="border-right: 0.02rem solid var(--ex-bg-white2);">
                <div class="amount blue">
                  {{ '--' }}
                </div>
                <div class="text-center">
                  {{ t('trade.ipo_detail_block_num') }}({{
                    currDetail.currency
                  }})
                </div>
              </div>
            ...
            <div class="info_box info_box--line">
              ...
              <div>
                {{ t('trade.ipo_detail_buy_value') }}({{ currDetail.currency }})
              </div>
            </div>
          </div>
          ...
          <div class="detail_item_list">
            ...
            <div class="detail_item">
              ...
              <div class="val">
                {{ currDetail.fee }} <span>{{ currDetail.currency }}</span>
              </div>
            </div>
            <div class="detail_item">
