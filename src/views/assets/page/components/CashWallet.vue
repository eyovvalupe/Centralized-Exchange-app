<template>
  <div class="relative overflow-hidden w-[6.86rem] h-[2.42rem] pt-[0.16rem] pl-[0.24rem]">
    <div class="absolute top-[0.02rem] left-[0.01rem] z-[-1]" style="width: 2.38rem;height: 1.02rem;">
      <img :src="getStaticImgUrl(`/static/icons/wallet_bg14.svg`)" alt="">
    </div>
    <div class="absolute top-[0] left-[0] z-[-1]" style="width: 6.86rem;height: 2.42rem;">
      <img :src="getStaticImgUrl(`/static/icons/wallet_bg13.svg`)" alt="">
    </div>
    <div class="absolute top-[0.05rem] right-[0] z-[-1]" style="width: 2.08rem;height: 2.36rem;">
      <img :src="getStaticImgUrl(`/static/icons/wallet_bg15.svg`)" alt="">
    </div>
    <span class="text-[0.32rem] bg-primary-text-color">现金账户</span>
    <div class="flex flex-col h-[1.16rem] z-[3] mt-[0.4rem] ml-[0.12rem]">
      <div class="flex">
        <span class="text-[0.24rem] text-color2 mb-[0.24rem] mr-[0.1rem]">现金账户(USDT)</span>
