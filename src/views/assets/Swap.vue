            ...
            <template #right>
                <div class="top-record" @click="goRecord">
                    <div class="top-record-icon">
                        <img v-lazy="getStaticImgUrl('/static/img/user/withdraw_record_icon.svg')" alt="img">
                    </div>
                    <!-- <span>
                        记录
                    </span> -->
        ...
        <div class="form">
            ...
            <div class="item_box">
                <div class="item account_item" @click="openDialog('from')">
                    ...
                    <div class="more">
                        <img v-lazy="getStaticImgUrl('/static/img/common/more.svg')" alt="more">
                    </div>
                </div>
            ...
            <div class="trans">
                ...
                <div class="trans_icon" @click="transAccount" :class="[transing ? 'transing_icon' : 'transing_stop']">
                    <img v-lazy="getStaticImgUrl('/static/img/assets/transfer.svg')" alt="img">
                </div>
