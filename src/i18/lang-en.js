export default {
  ...
  home: {
    ...
    selfSelectedRecommend: 'Custom Optionals',
  ...
  trade: {
    ...
    spot_time: 'Time',
    crypto_exchange: 'Crypto Contracts',
    margin_long: 'Long',
    margin_short: 'Short',
    pre_market: 'Pre-Market',
    short_sell: 'Short Sell',
    margin_risk: 'Margin Risk Ratio',
    spot_name: 'Crypto Pair Name',
  ...
  market: {
    ...
    market_buycoin_add_account:
      'You are about to be redirected to add a payment account. This will interrupt your current activity. Continue?',
    jump: 'Go Now',
