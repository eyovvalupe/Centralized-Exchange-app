export default {
  login: {
    ...
    pw_placeholder4: "Please input the country code",
  ...
  user_page: {
    ...
    about: "About",
    logout: "Log out",
    already_set_google: "Bound Google Auth",
    not_set_google_yet: "Unbind Google Auth",
  ...
  google_auth: {
    ...
    google_input_con: "Please input 6 letter code",
  ...
  account: {
    ...
    add_page_title: "Add payment account",
    add_tab1: "Crypto wallet",
    add_tab2: "Bank card",
    add_subtitle_type: "Crypto type",
    add_subtitle_network: "Chain network",
