...
<Popup round v-model:show="showAmountDialog" @closed="close()" closeable teleport="body">
    <div style="width: 6.4rem">
      ...
      <!-- 标题 -->
      <div
        style="text-align: center;font-size: 0.32rem;height:1rem;display: flex;align-items: center;justify-content: center;border:1px solid #EFF3F8;">{{$t('trade.ai_opening_pop_title')}}</div>
      ...
      <div
        ...
        <div style="display:flex;align-items:center;justify-content:center;flex-direction: column;flex:1">
          ...
          <b style="font-size:0.4rem;color:#014CFA;font-weight:bold">{{ amount }}</b>
        </div>
      </div>
