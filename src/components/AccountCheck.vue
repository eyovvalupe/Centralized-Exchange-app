  ...
  >
    <div class="account_check_popup">
      <div class="close_icon" @click="close">
        <img
          v-lazy="getStaticImgUrl('/static/img/common/close.svg')"
          alt="img"
        />
      </div>
      ...
      <div class="ac_body">
        <div class="ac_title" v-if="userInfo.role == 'guest'">
          升级为正式账户
        </div>
        <div class="fake_user" v-if="userInfo.role == 'guest'">
          <div class="fake_icon_box">
            <img
              v-lazy="getStaticImgUrl('/static/img/account/iden_up.svg')"
              alt="img"
            />
          </div>
          <div>模拟账号升级</div>
        ...
        <div class="ways">
          ...
          >
            <div class="left">
              ...
              <div class="info">
                ...
                <div class="btn">
                  <div class="btn_icon">
                    <img
                      v-lazy="getStaticImgUrl('/static/img/user/right.svg')"
                      alt="→"
                    />
                  </div>
                </div>
            ...
            <div class="right">
              <img
                v-lazy="getStaticImgUrl('/static/img/user/google-1.svg')"
                alt="google"
              />
              <img
                class="status_icon"
                v-lazy="getStaticImgUrl('/static/img/user/no.svg')"
                alt="no"
              />
            </div>
          </div>
          <div
            v-if="userInfo.kycl2 != 2"
            class="way"
          ...
          >
            ...
            <div class="right">
              <img
                v-lazy="getStaticImgUrl('/static/img/user/iden-1.svg')"
                alt="iden"
              />
              <img
                class="status_icon"
          ...
          <div v-if="userInfo.googlebind" class="way active_way">
            ...
            <div class="right">
              <img
                v-lazy="getStaticImgUrl('/static/img/user/google-2.svg')"
                alt="google"
              />
              <img
                class="status_icon"
                v-lazy="getStaticImgUrl('/static/img/user/ok.svg')"
                alt="no"
              />
            </div>
          </div>
          <div v-if="userInfo.kycl2 == 2" class="way active_way">
            ...
            <div class="right">
              <img
                v-lazy="getStaticImgUrl('/static/img/user/iden-2.svg')"
                alt="google"
              />
              <img
                class="status_icon"
          ...
          <div v-if="loanNum" class="load_num">
            借贷订单数
            <span style="font-weight: bold; color: red">{{ loanNum }}</span>
          </div>
        </div>
        ...
        <div class="server_icon">
          <img
            v-lazy="getStaticImgUrl('/static/img/common/server.svg')"
            alt="server"
          />
        </div>
        <div class="server">
          if you have questions contact <br /><span>customer service</span>
        </div>
      </div>
    </div>
  </Popup>
